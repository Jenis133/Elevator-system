            ...
            if (elevator.Location.Y >= 425 && door0.Location.X >= 0)
            {
                ...
                if (c==1)
                {
                    try
                    {
                        ...
                        dc.elevatordown(DateTime.Now, "Elevator Down","1");
        ...
        private void timer2_Tick(object sender, EventArgs e)
        {
            ...
            if (door0.Location.X <= -65 && elevator.Location.Y >= 425)
            {
                ...
                if (d == 1)
                {
                    ...
                    {
                        Database dc = new Database();
                        dc.elevatordown(DateTime.Now, "Down door open","1");
        ...
        private void timer4_Tick(object sender, EventArgs e)
        {
            ...
            if (door0.Location.X >= 0 && elevator.Location.Y>=425)
            {
                ...
                if (f == 1)
                {
                    ...
                    {
                        Database dc = new Database();
                        dc.elevatordown(DateTime.Now, "down door close","1");
        ...
        private void timer6_Tick(object sender, EventArgs e)
        {
            ...
            if (door1.Location.X <= -65 && elevator.Location.Y<=3)
            {
                ...
                if (g == 1)
                {
                    ...
                    {
                        Database dc = new Database();
                        dc.elevatordown(DateTime.Now, "Up door open","2");
        ...
        private void timer5_Tick(object sender, EventArgs e)
        {
            ...
            if (elevator.Location.Y <=3 && door1.Location.X >= 0)
            {
                ...
                if (h == 1)
                {
                    ...
                    {
                        Database dc = new Database();
                        dc.elevatordown(DateTime.Now, "Elevator Up","2");
        ...
        private void timer8_Tick(object sender, EventArgs e)
        {
            ...
            if (door1.Location.X >= 0 && elevator.Location.Y<=3)
            {
                ...
                if (i == 1)
                {
                    ...
                    {
                        Database dc = new Database();
                        dc.elevatordown(DateTime.Now, "Up door close","2");
